...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7376661834:AAGxE-svx0amqUf17RdVr5ZkdT84-a2DOKE")
...
DB_NAME = os.environ.get("DATABASE_NAME", "sample_mfix")
...
#start message
START_MSG = os.environ.get("START_MESSAGE", "<b>Hello {first} 👋\n\nI can store private files in Specified Channel and other users can access it from special link‼️</b>")
try:
    ADMINS=[]
